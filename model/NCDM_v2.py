...
class Net(nn.Module):
    ...
    def forward(self, stu_id, exer_id, kn_emb, ans_embedding, code_embedding):
        """
...
def calculate_similarity(embedding1, embedding2):
    ...
    embedding1_cpu = embedding1.cpu().detach().numpy()
    embedding2_cpu = embedding2.cpu().detach().numpy()
    similarity = cosine_similarity(embedding1_cpu, embedding2_cpu).flatten()[0]
    return similarity
